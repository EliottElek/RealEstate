...
public interface BuyerConstInterface {
    ...
    final String[] typesofproperties = {"All properties", "Single family detached house", "House", "Appartment", "Commercial Estate", "Industrial Estate", "land", "Agricol Land", "Building Land", "Castle", "Mansion", "Mas", "Ranch", "Farm", "Stud","Barge", "Bastide", "Windmill", "Barn"};
